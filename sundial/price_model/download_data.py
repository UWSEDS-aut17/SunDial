...
for (s_time, e_time) in zip(start_times, end_times):
	URL = 'http://oasis.caiso.com/oasisapi/SingleZip?queryname=PRC_LMP&startdatetime=' + s_time + 'T07:00-0000&enddatetime=' + e_time + 'T07:00-0000&version=1&market_run_id=DAM&node=' + NODE_LOCATION
